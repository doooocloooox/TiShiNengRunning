...
class RunPath(Base):
    ...
    __table_args__ = (Index('idx_school_code_run_path_id', 'school_code', 'run_path_id'),)
...
class TsnAccount_Model(Base):
    ...
    __table_args__ = (UniqueConstraint('user_id', 'school_id', name='user_id_school_id_unique'),)
